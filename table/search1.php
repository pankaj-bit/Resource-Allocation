                        ...
                        <form action="search1.php" method="post">
                            <div class="boking_table">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                            <button  id ="submit" name="submit" class="book_now_btn button_hover" >Search</button>
                                        </div>
                                </div>
...
if(isset($_POST['submit']))
{
    ...
    $q = "SELECT venue_id,venue_name from `venue` where venue_name = '$value'";
    $search=filterTable($q);
    $v=mysqli_fetch_array($search);
	$query="SELECT * FROM `resource` WHERE start_date='$value1' and venue_id=".$v['venue_id']."";
...
<?php
	...
	while($row=mysqli_fetch_array($search_result))
	{
		...
		echo "<td class=column3> ".$row['start_time']."</td>";
		echo "<td class=column4> ".$row['end_time']."</td>";
		echo "<td class=column6>".$v['venue_name']."</td>";
		echo "</tr></tbody>";
	}
